...
extension MiscellaneousTests {
    ...
    @Test
    func milliseconds() {
        #expect(XestiToolsCore.milliseconds(1.0) == 1_000)
        #expect(XestiToolsCore.milliseconds(0.5) == 500)
        #expect(XestiToolsCore.milliseconds(0.001) == 1)
        #expect(XestiToolsCore.milliseconds(0.0) == 0)
    }

    @Test
    func milliseconds_roundTrip() {
        let ms: Milliseconds = 1_500
        let ti = XestiToolsCore.timeInterval(ms)
        let backToMs = XestiToolsCore.milliseconds(ti)
    ...
    @Test
    func timeInterval() {
        let t1 = XestiToolsCore.timeInterval(1_000)
        let t2 = XestiToolsCore.timeInterval(500)
        let t3 = XestiToolsCore.timeInterval(1)
        let t4 = XestiToolsCore.timeInterval(0)
